...
const styles = {
  ...
  EmojiFoodBeverageIcon: { width: "32px", height: "32px", mr: 2 },
  pageContainer: {
    display: "flex",
    flexDirection: "row",
    alignItems: "center",
...
export function ResponsiveDrawer({ children, header }: Props) {
  ...
  const drawer = (
    <>
      <Container disableGutters sx={styles.mainContainer}>
        <EmojiFoodBeverageIcon sx={styles.EmojiFoodBeverageIcon} />
