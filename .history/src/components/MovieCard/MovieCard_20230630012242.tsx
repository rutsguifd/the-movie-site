...
export const MovieCard: FC<IMovieCardProps> = ({ movie, genresList }) => {
  if (typeof movie === Result) {
    const genres = bindMovieGenres(movie, genresList);
  }
