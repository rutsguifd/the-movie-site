...
export function SearchInput() {
  const [value, setValue] = useState<KeywordSearchResponse | null>(null);
  const [inputValue, setInputValue] = useState("");
  const [options, setOptions] = useState<readonly KeywordSearchResponse[]>([]);
    ...
    >
      {showSearch && (
        <Autocomplete
          ...
          onChange={(event: any, newValue: KeywordSearchResponse | null) => {
